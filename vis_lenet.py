...
class LeNet(nn.Module):
    ...
    def __init__(self):
        ...
        # 第一层神经网络，包括卷积层、线性**函数、池化层
        self.conv1 = nn.Sequential( 
            # in_channels=3; out_channels=32; kernel_size=(5,5); stride=1; padding=2.
